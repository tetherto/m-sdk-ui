 ...
 * Built on react-day-picker with Moria dark theme styling
 *
 * @example
 * ```tsx
 ...
 * Inspired by moria-app-ui PresetDateRangePicker with modal interface
 *
 * @example
 * ```tsx
...
// Default preset items (matching moria-app-ui)
